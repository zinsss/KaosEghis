...
def test_windows_socl_hotkey_uses_ctrl_alt_shift_f10() -> None:
    from KaosEghis.core.launcher_hotkey import _WindowsSoclHotkeyListener
    ...
    application = FakeApplication()
    user32 = FakeUser32()
    listener = _WindowsSoclHotkeyListener(
        lambda: events.append("socl"),
        application=application,
        user32=user32,
    )
